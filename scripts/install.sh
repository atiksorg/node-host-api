...
echo "[1/11] Установка Node.js, npm, git..."
...
echo "[2/11] Установка PM2..."
npm install -g pm2

# ─── 3. Установка Caddy ───

echo "[3/11] Установка Caddy..."
...
echo "[4/11] Создание пользователя ${NODE_HOST_USER}..."
...
echo "[8/11] Установка npm-зависимостей..."
cd "$ENGINE_DIR"
npm install --production

# ─── 9. Запуск управляющего API через PM2 ───

echo "[9/11] Запуск управляющего API..."
...
echo "[11/11] Настройка автозапуска PM2..."
